...
| 读取具体网页 / 文件 | 给出 URL 说「读一下 / 总结这个页面」自动用 web-page-fetch（优先于内置 WebFetch，并有 PreToolUse hook 动作点兜底：命中 site-fetch 清单的站点硬拦、其余首次软拦；HTML 渲染 + raw 原文 + 反爬识别） |
